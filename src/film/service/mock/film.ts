...
import { FilmGenre, Studio } from '../../entity';
...
export const film: FilmData = {
    ...
    filmNr: '000-0-00000-000-1',
    homepage: 'https://acme.at/',
    schlagwoerter: ['KLASSIKER'],
    regisseure: [
        {
            nachname: 'Alpha',
            vorname: 'Adriana',
...
export const filme: FilmData[] = [
    film,
    {
        ...
        titel: 'Beta',
        bewertung: 2,
        genre: FilmGenre.SCIENCE_FICTION,
        studio: Studio.DISNEY,
        preis: 22.2,
        rabatt: 0.022,
        lieferbar: true,
        datum: new Date('2018-02-02T00:00:00.000Z'),
        filmNr: '000-0-00000-000-2',
