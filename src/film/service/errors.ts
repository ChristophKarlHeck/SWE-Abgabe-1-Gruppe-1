...
export class FilmNrExists extends FilmServiceError {
    constructor(readonly filmNr: string, readonly id: string) {
        super();
    }
}

export type CreateError = FilmInvalid | TitelExists | FilmNrExists;
